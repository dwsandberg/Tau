...
, wfunc(alltypes
, symbol(internalmod, "bitcast", seqof.typeint, typeptr)
, empty:seq.byte
)
, wfunc(alltypes
...
, const64.8 + i64mul + i64add + i32wrapi64 + [i64load] + tobyte.3
+ LEBu.0
)
, wfunc(alltypes
...
, const64.8 + i64mul + i64add + i32wrapi64 + [f64load] + tobyte.3
+ LEBu.0
)
, wfunc(alltypes
, symbol(builtinmod.typeboolean, "fld", [typeptr, typeint], typeboolean)
, const64.8 + i64mul + i64add + i32wrapi64 + [i32load] + tobyte.2
+ LEBu.0
)
, wfunc(alltypes
...
, const64.24 + i64mul + i64add + i32wrapi64 + [f64load] + tobyte.3
+ LEBu.0
)
, wfunc(alltypes
...
, const64.32 + i64mul + i64add + i32wrapi64 + [f64load] + tobyte.3
+ LEBu.0
)
, wfunc(alltypes
