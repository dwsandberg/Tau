  ...
  if c = tobits.byte then
   ...
   let newstk = 
    if nocheck then
     ...
     report
      "type problem localset" + toword.arg + "locals" + locals + "/br"
      + text
     pop.stk
    ...
    ∈ [i32store, i64store, f64store, i64load, i64load8u, i32load, f64load, i32const, i64const] then
     ...
     if blktype = "void"_1 then
      ...
      report
       "JK" + blktype + top.stk + decodeop.lastop + toword.arg + "/br"
       + toseq.blkstk
       + "/br"
       + text
      pop.stk
     ...
     assert top.stk = locals_(arg + 1)
     report
      "type problem localtee" + toword.arg + "locals" + locals + "/br"
      + text
     stk
