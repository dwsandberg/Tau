...
/do setAttribute("lines", "d", lines) + setAttribute("curve", "d", curve)
...
{let a=dump.decode2.vector2}
let a=bitcast:seq.addrsym(inrec.vector2)
{let a = inbytes:addrsym(vector2)}
let r = for txt ="", e /in a do txt+%.addr.e+%.sym.e /do txt,
setElementValue("xx", r)
