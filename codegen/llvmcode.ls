...
do if c = bcwordsep then let discard0 = encodeword.acc, empty:seq.char else acc + c,
0
...
function addrsymX seq.addrsym for acc = empty:seq.addrsym, e ∈ addresssymbols do acc + e, acc
...
for a1 = 0, a2 = 0, a3 = 0, a ∈ addrsymX
do next(
 if sym.a = s1 then addr.a else a1
