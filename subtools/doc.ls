...
by the module in the /keyword use clauses. The /keyword exclude option lists the modules to ignore in the use clauses
.The /keyword include option restricts the modules considered to those listed.

* Examples:<* block
/br > usegraph /so+built core.libsrc <* none <a href ="../Tools/install1.html" > Result </a> *>
/br > usegraph /so+built core.libsrc exclude = seq standard <* none <a href ="../Tools/install2.html" > Result
</a> *>
/br > usegraph /so+built core.libsrc include = UTF8 words standard textio exclude = seq standard <* none <a
href ="../Tools/install3.html" > Result </a> *>
...
graph. The use graph below was created using the line <* block * usegraph exclude standard seq set UTF8 stack
graph otherseq *>
