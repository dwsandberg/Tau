...
give the result of" Value of the sum of 3 4 5 is 12".The grammar was produced with" LR1+tools
ParserExample.ls flags = codeonly"
...
if actioncode > 0 then
 ...
 let newstkele = 
  stkele(newstateno, action(ruleno, input, place, reduction.top(stk, rulelen)))
...
if ruleno = {G F #} 1 then R_1
 ...
 {The left side of the grammar rule is F and the right side is F I}
 ATTR (val.R_1 + val.R_2)
