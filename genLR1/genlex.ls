...
"if tokenstate.b ≠ 0 then &br if tokenstate.b = stringtoken then &br if next = &quot"+ merge(["&"_1,"quot"_1])+"&quot_1 then &br BB(stringtoken, tree(&quot $wordlist&quot_1, @(+, tree, empty:seq.tree.word, string.b)), b)&br else // add to string // &br stepresult(stk.b, place.b + 1, track.b, tokenstate.b, string.b + if next = merge([ &quot &&quot_1, &quot quot&quot_1])then &quot"+ merge(["&"_1,"quot"_1])+"&quot_1 else next)&br else if next = &quot //&quot_1 then &br BB(commenttoken, tree(&quot comment&quot_1, @(+, tree, empty:seq.tree.word, string.b)), b)&br else // add to string // stepresult(stk.b, place.b + 1, track.b, tokenstate.b, string.b + next)&br else"

Function gen(hash:boolean)seq.word 
 let alist = actionlist 
  let firstpart ="function consumeinput(b:stepresult, next:word)stepresult // generated by genlex module in tools //"+"&br let Wtoken ="+ toword.findindex("W"_1, tokenlist)+"&br let commenttoken ="+ toword.findindex("comment"_1, tokenlist)+"&br let stringtoken ="+ toword.findindex("$wordlist"_1, tokenlist)+"&br if tokenstate.b ≠ 0 then &br if tokenstate.b = stringtoken then &br if next = &quot"+ merge.["&"_1,"quot"_1]+"&quot_1 then &br BB(stringtoken, tree(&quot $wordlist &quot_1, @(+, tree, empty:seq.tree.word, string.b)), b)&br else // add to string // &br stepresult(stk.b, place.b + 1, track.b, tokenstate.b, string.b + if next = merge([ &quot & &quot_1, &quot quot &quot_1])then &quot"+ merge.["&"_1,"quot"_1]+"&quot_1 else next)&br else if next = &quot // &quot_1 then &br BB(commenttoken, tree(&quot comment &quot_1, @(+, tree, empty:seq.tree.word, string.b)), b)&br else // add to string // stepresult(stk.b, place.b + 1, track.b, tokenstate.b, string.b + next)&br else"
  let lastpart ="&br if w.act ≠ next then BB(Wtoken, tree(next), b)&br else if tokenno.act = 0 then &br if next = &quot"+ merge("&"+"quot")+"&quot_1 then // start word list // stepresult(stk.b, place.b + 1, track.b, stringtoken, &quot &quot)&br else // start comment // stepresult(stk.b, place.b + 1, track.b, commenttoken, &quot &quot)&br else BB(tokenno.act, tree(label.act), b)"
  firstpart +(if hash 
