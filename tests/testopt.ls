...
let cl = [
 ...
 , {test 35}
  "Start (int)
  /br %2 %1 seq.word:#(int, seq.word) word Define 3 %3 WORD e = (int, int) boolean Br2 (
  6, 1)
 ...
 , {test 37}
  ...
  /br 3 Exit
  /br %2 %1 seq.word:#(int, seq.word) word Define 3 %3 WORD a = (int, int) boolean Br2 (
  5, 1)
  /br %3 WORD b = (int, int) boolean Br2 (4, 1)
  /br %2 %1 seq.word:#(int, seq.word) word Define 4 %4 WORD c = (int, int) boolean Br2 (
  3, 1)
