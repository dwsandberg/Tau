...
let cl = [
 ...
 ,
  {optest24}
  "Start (int) /br %1 5 = (int, int) boolean Br2 (1, 2)
   /br 24 Exit
   /br 0 Exit
   /br EndBlock
   /br"
 , "25"
 ,
  {test 26 ???? could do better and discard outliners value for jump}
  "3 %1 seq.int:_(int, seq.int) int Define 2 Start (int) /br %2 3333 Jump (int, int) boolean Br2 (6, 1)
   /br 5 Br2 (5, 1)
   /br 7 Br2 (4, 1)
   /br 8 Br2 (3, 1)
   /br 9 Br2 (2, 1)
   ...
   /br EndBlock
   /br"
 , "%1 %2 Loop:3 (int, int) int /br %3 1 = (int, int) boolean Br2 (1, 2)
  /br %4 Exit
 ...
 ,
  {optest28}
  "Start (boolean) /br %1 0 > (int, int) boolean Br2 (1, 2)
 ...
 ,
  {optest30}
  "Start (int) /br %1 WORD test = (int, int) boolean Br2 (1, 2)
   /br %2 Exit
   /br %3 Exit
   /br EndBlock
   /br"
 ...
 , "%1"
 , {test 33} "33"
 , "%2 %1 seq.int:_(int, seq.int) int Define 3 Start (int) /br %3 1 Jump (int, int) boolean Br2 (7, 1)
  /br 9 Br2 (6, 1)
  /br 5 Br2 (5, 1)
  /br 2 Br2 (4, 1)
  /br 12 Br2 (3, 1)
 ...
 ,
  {test 35}
  "Start (int) /br %2 %1 seq.word:_(int, seq.word) word Define 3 %3 WORD e = (int, int) boolean Br2 (6, 1)
 ...
 ,
  {optest36}
  "Start (int) /br %1 WORD a = (int, int) boolean Br2 (3, 1)
 ...
 ,
  {test 37}
  "Start (int) /br %2 %1 seq.word:_(int, seq.word) word WORD xxx = (int, int) boolean Br2 (1, 2)
   /br 3 Exit
   /br %2 %1 seq.word:_(int, seq.word) word Define 3 %3 WORD a = (int, int) boolean Br2 (5, 1)
   /br %3 WORD b = (int, int) boolean Br2 (4, 1)
   /br %2 %1 seq.word:_(int, seq.word) word Define 4 %4 WORD c = (int, int) boolean Br2 (3, 1)
 ...
 , ""
 , "Start (int) /br %1 1 = (int, int) boolean Br2 (3, 1)
 ...
 ,
  {43}
  "Start (int) /br %1 4 = (int, int) boolean Br2 (1, 2)
 ...
 , "Start (int) /br %1 4 = (int, int) boolean Br2 (1, 2)
  ...
  /br EndBlock
  /br"
 , "0 0 %1 getseqlength (ptr) int Define 2 0 Loop:3 (int, int, int) int /br %5 %2 = (int, int) boolean Br2 (1, 2)
  /br 0 Exit
 ...
 ,
  {47}
  "%1 %2 %3 Loop:4 (int, int, int) int /br Start (seq.int)
 ...
 ,
  "^(dq."")"
  + "%1 getseqlength (ptr) int Define 2 %2 1+(int, int) int Loop:3 (seq.int, int) int /br %4 1 = (int, int) boolean Br2 (1, 2)
   /br 0 Exit
   ...
   /br EndBlock
   /br Define 6 %3 %6 seq (1) seq.int seq.word:+(seq.word, seq.word) seq.word %5 Continue 2
   /br EndBlock
   /br Define 7 %3"
 , {49} "WORD test"
]
...
""
else "/br <* literal FAILED *> test^(no) in optest. Got: 
 /br^(code)
