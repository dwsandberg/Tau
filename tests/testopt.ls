...
let cl =
 [
  ...
  "
  , {52}
  "Start(int)/br %1 JmpB 11 40:1 41:1 42:1 43:1:2 Jmp 11 /br 33 Exit /br 34 Exit /br EndBlock /br"
  , ""
...
if codelist sub no = code ∨ {no = 260 ∧ shuffletest.sameto(code, codelist sub no, 1,"")}false then ""
else "/br:(red."FAILED")test:(no)in optest. Got: /br:(code)/p Expected::(codelist sub no)"
