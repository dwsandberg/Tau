...
let cl =
 [
  ...
  /br EndBlock
  /br"
  , "%1 %2 >1 (int, int) ordering Define 5 %3 %4 >1 (int, int) ordering Define 6 Start (int)
  /br %5 1 = (int, int) boolean Br2 (1, 2)
  /br %6 Exit
  /br %5 Exit
  /br EndBlock
  /br"
...
/br"]}
let r =
 for acc = "", @e ∈ arithseq(n.cl, 1, 1)
 do acc + getcode(p2, cl, @e),
 acc
  + if [40, 20, 30, 20]
 = [
