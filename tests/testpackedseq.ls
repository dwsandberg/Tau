...
if pack ≠ unpack then
"FAIL seq not equal"
else if n.pack ≤ blksize ∧ typ = 0 ∧ size = 8 then
"PASS std" + toword.n.pack
else if n.pack ≤ blksize / size ∧ typ = 1 then
"PASS packed" + toword.n.pack
else if n.pack > blksize / size ∧ typ ∉ [0, 1] then
"PASS block" + toword.n.pack
...
[get:T, get:T, get:T, get:T, get:T, get:T]
...
"packed" + toword.n.a
else if t = getseqtype.constantseq(1, get:T) then
"const"
else if ispseq.a then
"pseq"
else "unknown"
...
let kind = seqkind.a,
if kind = "pseq" then
let p = to:pseq.T(a), "(^(seqstruct.a.p)^(seqstruct.b.p))"
else kind 