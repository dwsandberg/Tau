...
let inputs =
 [
  ...
  , analtest(
   ...
   , "Start (int)
   /br %1 JmpB 9 2:2 4:2 3:2:1 Jmp 9
  ...
  , analtest(
   ...
   , "Start (int)
   /br %1 JmpB 9 5:1 3:2 1:3:4 Jmp 9
   /br 6 Exit
   /br 4 Exit
   /br 2 Exit
   /br 8 Exit
  ...
  , analtest(
   ...
   , "Start (int)
   /br %3 JmpB 11 5:1 2:1 12:1 3:1:2 Jmp 11
   /br 10 Exit
   /br 11 Exit
   /br EndBlock
   /br"
  ...
  , analtest(
   ...
   /br 0 Exit
   /br %1 JmpB 9 2:4 4:4 3:1:2 Jmp 9
   /br %8 %9 %4 Continue 3
  ...
  , analtest(
   ...
   , "Start (int)
   /br %1 JmpB 11 1:1 2:2 5:3 7:4:5 Jmp 11
   /br 1 Exit
   /br 2 Exit
   /br 5 Exit
   /br 7 Exit
  ...
  , analtest(
   ...
   , "Start (int)
   /br %1 JmpB 17 8:1 9:1 10:1 11:1 12:1 13:1 14:2:3 Jmp 17
   /br %4 Exit
   /br 14 Exit
   /br 9 Exit
   /br EndBlock
