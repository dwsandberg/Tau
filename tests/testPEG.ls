...
{COMMAND}
let gram103 = maketable."ZZ any = ! C any /action X $.1 = $.2
/br C any = /action"
let gram104 = maketable."* ZZ3 any = V /action $.0 $.1 = $.2 ;
...
let result =
 check(tbl, "a", "Match 4 3")
  ...
  + checkerror("A a", "<* literal Error in PEG grammar *> /br /br Unparsed Input: A a"),
