...
false
= for acc = true, e ∈ [0 - 1, 256, 255, 0]
do acc ∧ isbyte.e,
acc

function t032 boolean
for acc = true, e ∈ [23, 4, 5, 255, 7, 2, 255]
do acc ∨ isbyte.e,
acc
...
10
= for acc = 0, e ∈ [1, 2, 3, 4] do acc + e,
acc

function t037 boolean
24
= for acc = 1, e ∈ [1, 2, 3, 4] do acc * e,
acc

Function t038 boolean
[1, 2, 3, 4]
= for acc = empty:seq.int, e ∈ [1, 2, 3, 4]
do acc + e,
acc
...
= for acc = "code glyph", e ∈ arithseq(43, 1, 48)
...
do
 next(
  for acc2 = acc1, u = 6, i ∈ [4, 5] do next(acc2 + 1, 5),
  acc2
  , 6
 ),
acc1 = 6
