...
let z = 
 ...
 , testerror(in
 , "
   /< literal parse error:unexpected end of paragraph  />"
 ...
 , testerror(in, "
   /< literal stray} />", "function f1(a:int)boolean a+}a")
 , testerror(in
 ...
 , testerror(in, "
   /< literal cannot resolve type hhh", "function f1(z:hhh)int 3")
 , testerror(in, "
   /< literal cannot resolve type xxx", "function f1(z:int)xxx 3")
