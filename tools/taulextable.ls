...
Function totext(l:lexaction1)seq.word
 ...
 ' merge("&"+"' + encodeword.subseq(decodeword.w.l, 2, 100) + '")'
  ...
  ('"'
  + if w.l = '"'_1 then merge.("&" + "quot")else w.l)
  + '"_1 '
 let label = if label.l = '"'_1 then merge.("&" + "quot")else label.l
  "token(" + w + "," + toword.tokenno.l + ',attribute."' + label
  + '")'

Function getlextable seq.word // generate the lextable for the Tau compiler. //"&br &br function Wtoken int // generated by genlex module in tools //"
...
+ "&br &br function lextable seq.token // generated by genlex module in tools // ["
+ @(seperator("&br,"), totext,"", actionlist)
+ "]"
