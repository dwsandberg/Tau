#!/bin/sh  tau stdlib tools callgraphbetween stdlib pass2 interpreter
...
uses stdlib
exports baseTypeCheck doc genLR1 profile taulextable testall tools uniqueids wordgraph
...
else if arg = "testprofile"then testprofile.arg2
else if arg = "doclibrary"then doclibrary.arg2
else if arg = "htmlcode"then doclibrary.arg2
...
else if arg = "taugrammar"then gentau2
else if arg = "testall"then testall
else if arg = "baseTypeCheck"then baseTypeCheck.arg2
else if arg = "test3"then test3.arg2 else"unknown arg" + args
