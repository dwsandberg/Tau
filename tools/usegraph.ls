...
{COMMAND /strong usegraph graphs /em use releationshhip between modules in source code. 
/br
/br options: 
...
/p Examples:<* block > usegraph /sp+built core.libsrc /tag <a /sp href ="..
/documentation/Ex1usegraph.html" > Result /tag </a> /sp
/br > usegraph /sp+built core.libsrc exclude = seq standard /tag <a /sp href ="..
/documentation/Ex2usegraph.html" > Result /tag </a> /sp
/br > usegraph /sp+built core.libsrc include = UTF8 words standard textio exclude = seq
standard /tag <a /sp href ="../documentation/Ex3usegraph.html" > Result /tag </a> /sp
