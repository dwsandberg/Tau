...
Function action(ruleno:int, input:seq.word, place:int, R:reduction.attribute2)attribute2
 ...
 else if ruleno = \\ F W _(FP)T E \\ 3 then pretty.[ key.R_1, R_2, R_3, R_4, R_5, R_6, if width.R_4 + width.R_7 > 30 then block.R_7 else R_7]
 ...
 else if ruleno = \\ F W *N(FP)T E \\ 7 then pretty.[ key.R_1, R_2, R_3, R_4, R_5, R_6, if width.R_4 + width.R_7 > 30 then block.R_7 else R_7]
 ...
 else if ruleno = \\ A let W = D \\ 36 then pretty.[ R_1, R_2, R_3, R_4]
 else if ruleno = \\ E A E \\ 37 then checkpara(R_1, block(" &br let assert", R_2))
 ...
 let t =" &{ comment \\" + escapeformat.text.R_1 << 1 >> 1 + "\\  &}"
  ...
  else if ruleno = \\ B for W-E, W = E, W, \\ 47 then
 pretty.[ R_1, R_2, R_3, R_4, R_5, R_6, R_7, R_8, R_9, R_10, R_11]
 else if ruleno = \\ B for W-E,W = E , ,\\ 48 then
 pretty.[ R_1, R_2, R_3, R_4, R_5, R_6, R_7, R_8, R_9, R_10]
  else if ruleno = \\ E B , D \\ 49 then
 pretty.[ R_1, R_2, if width.R_1 < 30 then R_3 else block.R_3]
 else if ruleno = \\ E B E , D \\ 50 then
 pretty.[ R_1, R_2, R_3,  if width.R_1 + width.R_2 < 30 then R_4 else block.R_4]
