...
Function testjulian boolean [ tojulian(2000, 1, 1)
  , tojulian(1999, 1, 1)
  , tojulian(1987, 1, 27)
  , tojulian(1987, 6, 19)
  , tojulian(1988, 1, 27)
...
Function dayofyear(t:timestamp)int toint.t /(24 * 60 * 60) - tojulian(fromJuliantointseq(toint.t /(24 * 60 * 60))_1, 1, 1)+ 1
...
Function totimestamp(year:int, month:int, day:int, hour:int, minute:int, second:int)timestamp timestamp(((tojulian(year, month, day)* 24 + hour)* 60 + minute)* 60 + second)
