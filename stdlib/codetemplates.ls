...
for acc = empty:seq.match5, e ∈ other do
 ...
 let discard =
  ...
  , emptyinternalbc
  ,"ACTARG"_1
  , ptrtoint(functyp, symboltableentry([ mangledname(getoption.getCode(theprg, f1), f1)], functyp))
  )
 acc
/for(acc)
...
findencode.match5(d, 0, emptyinternalbc,"NOTFOUND"_1, 0, empty:seq.symbol, [ i64])
