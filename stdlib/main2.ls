...
function   extractencoding (  s:seq.word)  seq.mytype
 if length.s > 3 &and s_1="type"_1 &and s_4 in "Encoding encoding" then
    [ mytype(towords.parameter(types(parse(headerdict, s))_1)+"invertedseq")]
 else 
   empty:seq.mytype
