...
= for e ∈ arithseq(43, 1, 48), acc ="code glyph"; acc + [ toword.e, encodeword.[ char.e]]

function t044 boolean '"()+,-.:= [ \]^_' = standalonechars

Function standalonechars seq.word for e ∈ arithseq(length.classifychar, 1, 1), acc ="";
...
function print(a:set.int)seq.word for e ∈ toseq.a, acc =""; acc + toword.e
