...
if partno = 2 then createtype(common, R sub (n.R - 2), R sub (n.R - 1), place.rinfo)
else if partno = 3 then R sub n.R
else if partno = 4 then createfunc(common, place.rinfo, text.R sub (n.R - 3), null, R sub (n.R - 2), R sub (n.R - 1))
else if partno = 5 then createfunc(common, place.rinfo, text.R sub (n.R - 2), null, null, R sub (n.R - 1))
...
else if partno = 7 then createfunc(common, place.rinfo, text.R sub (n.R - 3), R sub (n.R - 2), null, R sub (n.R - 1))
else if partno = 8 then R sub (n.R - 1) + R sub n.R
else if partno = 9 then R sub (n.R - 1) + R sub n.R
else if partno = 10 then addpara(common, text.R sub (n.R - 1), R sub n.R, place.rinfo)
else if partno = 11 then addpara(common, ":", R sub n.R, place.rinfo)
else if partno = 12 then toAttribute(R sub (n.R - 1), text.R sub (n.R - 1) + "." + text.R sub n.R)
else if partno = 13 then R sub n.R
else if partno = 14 then R sub n.R
else if partno = 15 then R sub (n.R - 1)
else if partno = 16 then R sub (n.R - 1)
else if partno = 17 then R sub (n.R - 1)
else R sub 1
...
type recoverInfo is stk:stack.frame, input:seq.word, place:int, faili:int
