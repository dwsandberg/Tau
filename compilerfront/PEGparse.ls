...
/br Non-terminals:B C Code Code' CodeFormat F1 FP FP' N2 Part Part' Part2 Part2' S Str Str1 Str3 Type /br
Terminals:()*+,.// //action:: = K[]any dq function genPEG{}/br
S ←[dq CodeFormat / function genPEG(FP FP')Type{Str3 B}/ function genPEG(FP FP')Type / F1 /br
