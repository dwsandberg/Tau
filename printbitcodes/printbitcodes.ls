...
{COMMAND Decode a a bitcode file generated by the compiler into a more readable format./br
flags /br
objects--decode reference to objects. /br
bitcode--includes code to generate module that can be compile with runcode.ls to regenerate the.bc file. /br
