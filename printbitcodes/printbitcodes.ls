...
{ENTRYPOINT Decode a a bitcode file generated by the compiler into a more readable format.
 /br flags
 ...
 let tp = instop.1_d,
  ...
  {skip BLOCKCOUNT} next(slot, result, inblock)
   ...
   let pattern =
    ...
    "getelementptr (^(reglabel),^((3_d + 1)_types.info),
