...
Function testopt seq.word    
   let p2=secondPass("testall"_1)
      let cl=["LIT 7","LIT 12","LIT 1","LIT 2","WORD FIRST","WORD AB","WORDS 2 A B","LIT 7","LIT 11", "LIT 2",
       "LIT 1", "LIT 0","LIT 4607182418800017408","LIT 44","LIT 2","LIT 46"]
   let c2=constantseq(99,"")+["PARAM -2 PARAM -3 FIRSTVAR 1 LOOPBLOCK 3 LOCAL 1 LIT 1 Q3DZbuiltinZintZint 2 THENBLOCK 1 LOCAL 2 ELSEBLOCK 1 LOCAL 1 LIT 1 Q2DZbuiltinZintZint 2 LOCAL 1 LOCAL 2 Q2AZbuiltinZintZint 2 CONTINUE 2 if 3 FINISHLOOP 2"
   ,"PARAM-2 LIT 0 Q3EZbuiltinZintZint 2 THENBLOCK 1 LIT 10 PARAM-3 Q3EZbuiltinZintZint 2 ELSEBLOCK 1 LIT 0 if 3",
   "PARAM-2 LIT 0 Q3EZbuiltinZintZint 2 THENBLOCK 1 LIT 1 ELSEBLOCK 1 LIT 10 PARAM-3 Q3EZbuiltinZintZint 2 if 3"]
...
use textio
 ...
 Function filter(name:word,s:seq.word) seq.word
  if name=s_1 then  s  else ""
...
Function optest101(a:int,b:int)  boolean   a > 0  &and b < 10

Function optest102(a:int,b:int)  boolean   a > 0  &or b < 10
