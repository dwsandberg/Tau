...
// optest24   // "%1 5 Q3DZbuiltinZintZint  2 3 BR 3 
 &br 24 EXITBLOCK 1 
 &br 0 EXITBLOCK 1 
 &br BLOCK 3  &br "  
 ,// optest25 // "
  %1 3 Q5FZintzseqZintzseqZint  DEFINE 2 %2 9 Q3EZbuiltinZintZint  5 2 BR 3 
&br %2 9 Q3DZbuiltinZintZint  7 3 BR 3 
&br %2 5 Q3DZbuiltinZintZint  7 4 BR 3 
&br %2 8 Q3DZbuiltinZintZint  7 8 BR 3 
&br %2 10 Q3DZbuiltinZintZint  7 6 BR 3 
&br %2 3333 Q3DZbuiltinZintZint  7 8 BR 3 
&br 25 EXITBLOCK 1 
&br 2 EXITBLOCK 1 
&br BLOCK 8
&br  "
 ,"26"
,"%1 %2  3 LOOPBLOCK  3  
&br %3  1 Q3DZbuiltinZintZint  3 4 BR 3 
 &br %4 EXITBLOCK 1 
 &br %3 1 Q2DZbuiltinZintZint  %3 %4 Q2AZbuiltinZintZint  CONTINUE 2  
 &br BLOCK 4 &br",
"%1  0 Q3EZbuiltinZintZint   2  3  BR 3  
&br 10 %2 Q3EZbuiltinZintZint    EXITBLOCK 1  
 &br 0  EXITBLOCK 1 
  &br  BLOCK 3 &br",
"%1  0 Q3EZbuiltinZintZint   2  3   BR 3  
&br 1  EXITBLOCK 1  
&br 10 %2 Q3EZbuiltinZintZint  EXITBLOCK 1  &br BLOCK 3 &br"
, //  optest30 // "%1 WORD test Q3DZbuiltinZintZint  2 3 BR 3  
&br %2 EXITBLOCK 1 
&br %3 EXITBLOCK 1 
&br BLOCK 3 &br"
, // test 31 // "%1 %2 Q5FZintzseqZintzseqZint  DEFINE 3 %3 3 Q3EZbuiltinZintZint  4 2 BR 3 
&br %3 3 Q3DZbuiltinZintZint  5 3 BR 3 
&br %3 1 Q3DZbuiltinZintZint  5 6 BR 3 
&br %3 4 Q3DZbuiltinZintZint  5 6 BR 3 
&br 10 EXITBLOCK 1 
&br 11 EXITBLOCK 1 
&br BLOCK 6 &br "  ]  
...
Function getcode(p2:seq.seq.word,  codelist:seq.seq.word, no:int)seq.word
 ...
 function removeoptions(s:seq.word,i:int) seq.word
    if i=length.s then if not(s_i="optionZbuiltinZTZwordzseq"_1)then subseq(s,2,length.s) else removeoptions(s,i-2)
    else 
    if not(s_i='"'_1) then removeoptions(s,i-1) else subseq(s,2,i-1)
