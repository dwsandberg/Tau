...
Function testrandomphrase seq.word 
 if"The umber ant ambles the opal nurse"= getphrase.20 
  then"PASS"
...
Function getphrase(seed:int)seq.word 
 let a = randomseq(seed, 6)
  {"The"+ adjectives_(a_1 mod 140 + 1)+ nouns_(a_2 mod 140 + 1)+ verbs_(a_3 mod 140 + 1)+"the"+ adjectives_(a_4 mod 140 + 1)+ nouns_(a_5 mod 140 + 1)}
