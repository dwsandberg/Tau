...
else if abstracttypename.s = 1#"process" then ptr.i64
else
...
1
#for acc = empty:seq.match5, e ∈ t
do [addtemplate(replaceTsymbol(e, sym), length, b)],
acc
...
let args =
 if action.t = 1#"CALL" then empty:seq.int
