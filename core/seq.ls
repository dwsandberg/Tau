...
let la = n.a,
if n.a = 0 then b else let lb = n.b, if lb = 0 then a else catnonzero(a, b)
...
[idxNB(a, 1), idxNB(b, 1)]
 ...
 let ta = to:pseq.T(a),
  if n.toseq.ta = 0 then
   let tb = to:pseq.T(b),
    if n.toseq.tb = 0 ∨ n.a.tb + n.b.tb ≠ n.toseq.tb then
    toseq.pseq(totallength, a, b, 0)
    else cat3(totallength, a, a.tb, b.tb)
  else if n.a.ta + n.b.ta ≠ n.toseq.ta then
  toseq.pseq(totallength, a, b, 0)
 ...
 let p = to:pseq.T(s),
  ...
  toseq.pseq(finish - start + 1, s, s, start - 1)
   ...
   let adjfinish = start.p + finish - n.a.p,
    ...
    subseq(a.p, start.p + start, n.a.p) + subseq(b.p, 1, adjfinish)
